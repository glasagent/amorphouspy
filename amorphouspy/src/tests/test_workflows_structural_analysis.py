"""Tests for amorphouspy.structure_characterization.pipeline — full coverage."""

import warnings
from typing import TYPE_CHECKING, cast
from unittest.mock import patch

import amorphouspy.structure_characterization.pipeline as sa_module
import numpy as np
...
def test_analyze_structure_sio2_glass() -> None:
    ...
    atoms = read(SIO2_XYZ)
    with patch(
        "amorphouspy.structure_characterization.pipeline.compute_guttmann_rings",
